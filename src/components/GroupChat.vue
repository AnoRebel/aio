  ...
  <div class="font-sans antialiased h-screen flex">
      ...
      <div class="mb-8">
        ...
        <div class="flex items-center mb-3 px-4">
          ...
          <span class="text-white opacity-75"
            >Adam Wathan <span class="text-grey text-sm">(you)</span></span
          >
        </div>
        <div class="flex items-center mb-3 px-4">
          <span class="bg-green rounded-full block w-2 h-2 mr-2"></span>
    ...
    <div class="flex-1 flex flex-col bg-white overflow-hidden">
      ...
      <div class="px-6 py-4 flex-1 overflow-y-scroll">
        ...
        <div class="flex items-start mb-4 text-sm">
          <img
            src="https://pbs.twimg.com/profile_images/929910740156215296/yDEC9GW9_400x400.jpg"
            class="w-10 h-10 rounded mr-3"
          />
          <div class="flex-1 overflow-hidden">
            <div>
            ...
            <p class="text-black leading-normal">
              <a href="#" class="inline-block bg-blue-lightest text-blue no-underline"
                >@Adam Wathan</a
              >
